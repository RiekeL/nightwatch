...
ClientManager.prototype.init = function(opts) {
  ...
  this['@client'].once('selenium:session_create', function() {
    ...
    var browserVersion = this.api.options.desiredCapabilities.browser_version || this.api.capabilities.version || this.api.capabilities.browserVersion;
    var platformVersion = this.api.options.desiredCapabilities.os_version || this.api.capabilities.platform || this.api.capabilities.platformVersion;
