...
ClientManager.prototype.init = function(opts) {
  ...
  this['@client'].once('selenium:session_create', function() {
    ...
    var browserVersion = capabilities.version || capabilities.browserVersion || '';
    var platformVersion = capabilities.platform || capabilities.platformVersion || '';
    var mobileDevice = capabilities.mobile ? capabilities.mobile.version.replace(' ','_')+'_' : '';
    self.options.report_prefix = mobileDevice + browserName + '_' + browserVersion + '_' + platformVersion + '_';
  });
  return this;
};
