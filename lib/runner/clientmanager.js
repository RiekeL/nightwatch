...
ClientManager.prototype.init = function(opts) {
  ...
  this['@client'].once('selenium:session_create', function() {
    ...
    var browserVersion = this.api.options.desiredCapabilities.browser_version || capabilities.version || capabilities.browserVersion;
    var platformName = this.api.options.desiredCapabilities.os || capabilities.platform || 'unknownOSName';
    var platformVersion = this.api.options.desiredCapabilities.os_version || capabilities.platformVersion || 'unknownOSVersion';

    self.options.report_prefix = browserName + '_' + browserVersion + '_' + platformName + '_' + platformVersion + '_';
  });
  return this;
};
